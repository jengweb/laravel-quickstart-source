...
class APIHelper
{
     ...
     */
    public static function getParentPagesData($friendlyUrl = null, $languageCode = null, $filterPages = [], $filterItems = [])
    {
        $site = CMSHelper::getSite();
     ...
     * @return array|mixed|null|string
     */
    public static function getChildPagesData($friendlyUrl = null, $languageCode = null, $filterPages = [], $filterItems = [])
    {
        $site = CMSHelper::getSite();
     ...
     * @return array|mixed|null
     */
    public static function getPagesByCategories($categories, $languageCode = null, $filterItems = [])
    {
        $site = CMSHelper::getSite();
     ...
     * @return mixed
     */
    public static function removeLanguageCodeFromUrl($languageCode, $url)
    {
